...
{
    char *diff1_buf = (char *) cc_calloc(METRIC_BUF_LEN * nmetric, sizeof(char));
    char *diff2_buf = (char *) cc_calloc(METRIC_BUF_LEN * nmetric, sizeof(char));
    char *metric1_buf = (char *) cc_alloc(METRIC_BUF_LEN * sizeof(char));
    char *metric2_buf = (char *) cc_alloc(METRIC_BUF_LEN * sizeof(char));
