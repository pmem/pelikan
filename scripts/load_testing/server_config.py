...
""".format(instances=instances, engine=engine, prefill_opt=prefill_opt))
  os.chmod(fname, 0777)
...
if __name__ == "__main__":
  ...
  parser.add_argument('--engine', dest='engine', type=str, default=ENGINE, help='type of engine: twemcache or slimcache')
